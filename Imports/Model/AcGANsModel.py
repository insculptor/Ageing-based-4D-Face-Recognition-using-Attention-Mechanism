...
class AcGANsModel(object):
    def __init__(self,
        ...
        self.num_epoch_test = args.num_epoch_test
        self.lr_decay_epoch = args.lr_decay_epoch
        self.lr_decay = args.lr_decay
        # loss weight
        self.D_prob_weight = args.D_prob_weight
        self.D_cond_weight = args.D_cond_weight
        self.gradient_penalty_weight = args.gradient_penalty_weight
        self.mask_weight = args.mask_weight
        self.mask_smooth_weight = args.mask_smooth_weight
        self.update_netG_every_n_iter = args.update_netG_every_n_iter
        self.begin_save_epoch =args. begin_save_epoch

        # others
        self.restore_epoch = args.restore_epoch
        self.resume_time = args.resume_time
        self.label_range = args.label_range
        self.generate_age_list = args.generate_age_list

        self.test_size = args.test_size
        self.data_root = args.cacds_data_dir
        self.age_group = args.age_group
        self.batch_size = args.batch_size
        self.image_size = args.image_size
        self.train_save_batch = args.train_save_batch
        self.test_save_batch = args.test_save_batch
        self.is_ordinal_reg = args.is_ordinal_reg
        ...
        self.images_save_dir = os.path.join(args.output_dir, self.model_name, self.dataset_name, 'save_images',
                                            self.save_time)
        os.makedirs(self.images_save_dir, exist_ok=True)
        # save path for models
        self.save_model_path = os.path.join(args.output_dir, self.model_name, self.dataset_name, 'save_models',
                                            self.save_time)
