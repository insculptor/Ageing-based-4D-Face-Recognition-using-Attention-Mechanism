...
class CACD_AlexNet(data.Dataset):
    def __init__(self, split='train', transforms=None, label_transforms=None):
        list_root = "C:/Users/91966/Desktop/Ageiiing/Data/CACDS/lists"
        data_root = "C:/Users/91966/Desktop/Ageiiing/Data/CACDS/Processed_img"
        if split == "train":
...
if __name__=="__main__":
    ...
    CACD_dataset=CACD_AlexNet("train",transforms,None)
